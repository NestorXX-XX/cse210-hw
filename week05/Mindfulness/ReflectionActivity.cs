class ReflectingActivity : Activity
{
    ...
    public ReflectingActivity()
    {
        ...
        "have shown strength and resilience. This will help you recognize the power you have" +
    ...
    public void Run()
    {
        ...
        ShowSpinner(3);
        Console.WriteLine();
        Console.WriteLine("Consider the the following prompt: ");
        Console.WriteLine();
        int indexPrompt = Random.Shared.Next(_prompts.Count);
        ...
        {
            Console.Write($"> {_questions[indexQuestions]} ");
            ShowSpinner(8);
            Console.WriteLine();
